...
{
	GPIO_ResetBits(GPIOA,GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_7);	//置1关闭LED
	GPIO_ResetBits(GPIOC,GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3);
	
	GPIO_ResetBits(GPIOA,GPIO_Pin_8);	//置1关闭LED
	GPIO_ResetBits(GPIOC,GPIO_Pin_14|GPIO_Pin_15);
	
	GPIO_ResetBits(GPIOB,GPIO_Pin_6);	//置1关闭LED
